...
namespace GenShop.Invoicing.Domain.Tests.Unit.Models.VATRateCalculation
{
    [TestClass]
    [TestCategory("Unit")]
    public class VATPayingSupplierWithEUNonVATPayingCustomerInDifferentCountryTests
    {
        private VATPayingSupplierWithEUNonVATPayingCustomerInDifferentCountry _sut;

        [TestInitialize]
        public void Initialize()
        {
            _sut = new VATPayingSupplierWithEUNonVATPayingCustomerInDifferentCountry();
        }
        ...
        [TestMethod]
        public void Returns_failure_result_for_non_VAT_paying_supplier_with_EU_non_VAT_paying_customer_in_different_country()
        {
            var supplier = SupplierMockBuilder.Build(
                address: AddressMockBuilder.BuildGermany(),
                paysVat: false);
        ...
        [TestMethod]
        public void Returns_failure_result_for_VAT_paying_supplier_with_non_EU_non_VAT_paying_customer_in_different_country()
        {
            var supplier = SupplierMockBuilder.Build(
                address: AddressMockBuilder.BuildGermany(),
                paysVat: true);
